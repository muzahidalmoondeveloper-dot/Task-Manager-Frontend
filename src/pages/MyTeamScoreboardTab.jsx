...
// A team member only sees their own scoreboard for this team — reuses the
// same per-user scoreboard endpoint as UserScoreboardPage, scoped to this
// team via team_id, but embedded in the Team tab instead of a standalone page.
export default function MyTeamScoreboardTab({ team, userId }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setError(err.message || "Unable to load your scoreboard.");
      } finally {
  ...
  const { summary, score, explanation, trend } = data;
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <div className="flex flex-wrap items-start justify-between gap-6">
          <div>
            <p className="text-sm font-medium text-slate-500">My Score</p>
