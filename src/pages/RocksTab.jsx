...
export function RockModal({ team, users, objectives, teams, projects, currentUser, editing, onClose, onSave, saving, defaultStatus = "backlog" }) {
...
export default function RocksTab({ team, canManage }) {
  ...
  const activeTab = searchParams.get("rocks_status") || "active";
  function setActiveTab(status) {
    const next = new URLSearchParams(searchParams);
    next.set("rocks_status", status);
